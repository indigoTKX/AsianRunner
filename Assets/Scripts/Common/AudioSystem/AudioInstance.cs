...
[CreateAssetMenu(fileName = "NewAudioInstance", menuName = "AudioInstance")]
public class AudioInstance : ScriptableObject
{
    ...
    private Dictionary<AudioSourceController, Action> _onEndHandlers = new();
    ...
    private void RemoveSource(AudioSourceController source)
    {
        source.OnClipEnded -= _onEndHandlers[source];
        _onEndHandlers.Remove(source);
